...
package com.dtstack.flink.sql.side.postgres;
...
public class PostgresAsyncReqRow extends RdbAsyncReqRow {

    private static final Logger LOG = LoggerFactory.getLogger(PostgresAsyncReqRow.class);

    private final static String POSTGRES_DRIVER = "org.postgresql.Driver";

    public PostgresAsyncReqRow(RowTypeInfo rowTypeInfo, JoinInfo joinInfo, List<FieldInfo> outFieldInfoList, SideTableInfo sideTableInfo) {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        pgClientConfig.put("url", rdbSideTableInfo.getUrl())
                .put("driver_class", POSTGRES_DRIVER)
